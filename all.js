! function(e, t) {
    ...
    E.fn = E.prototype = {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || E.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], s !== (r = e[t]) && (u && r && (E.isPlainObject(r) || (i = E.isArray(r))) ? (o = i ? (i = !1, n && E.isArray(n) ? n : []) : n && E.isPlainObject(n) ? n : {}, s[t] = E.extend(u, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, E.extend({
        ...
        globalEval: function(e) {
            var t, n = eval;
            (e = E.trim(e)) && (1 === e.indexOf("use strict") ? ((t = T.createElement("script")).text = e, T.head.appendChild(t).parentNode.removeChild(t)) : n(e))
        },
        camelCase: function(e) {
            return e.replace(l, "ms-").replace(u, f)
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (d(Object(e)) ? E.merge(n, "string" == typeof e ? [e] : e) : a.call(n, e)), n
        },
    ...
    var p = function(n) {
        var e, h, x, o, i, g, f, m, w, l, u, A, C, s, T, v, a, c, y, E = "sizzle" + 1 * new Date,
            b = n.document,
            S = 0,
            r = 0,
            d = ie(),
        ...
        try {
            L.apply(t = q.call(b.childNodes), b.childNodes), t[b.childNodes.length].nodeType
        } catch (e) {
            L = {
            ...
            if (!r && ((t ? t.ownerDocument || t : b) !== C && A(t), t = t || C, T)) {
                if (11 !== p && (u = J.exec(e)))
                    if (i = u[1]) {
                        ...
                        if ((i = u[3]) && h.getElementsByClassName && t.getElementsByClassName) return L.apply(n, t.getElementsByClassName(i)), n
                    } if (h.qsa && !k[e + " "] && (!v || !v.test(e))) {
                    if (1 !== p) d = t, f = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(Z, "\\$&") : t.setAttribute("id", a = E), o = (c = g(e)).length, l = V.test(a) ? "#" + a : "[id='" + a + "']"; o--;) c[o] = l + " " + he(c[o]);
        ...
        for (e in h = re.support = {}, i = re.isXML = function(e) {
                ...
                return r !== C && 9 === r.nodeType && r.documentElement && (s = (C = r).documentElement, T = !i(C), (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ne, !1) : n.attachEvent && n.attachEvent("onunload", ne)), h.attributes = se(function(e) {
                ...
                }), v = v.length && new RegExp(v.join("|")), a = a.length && new RegExp(a.join("|")), t = Y.test(s.compareDocumentPosition), y = t || Y.test(s.contains) ? function(e, t) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !h.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === b && y(b, e) ? -1 : t === C || t.ownerDocument === b && y(b, t) ? 1 : l ? H(l, e) - H(l, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return u = !0, 0;
                    var n, r = 0,
                        i = e.parentNode,
                        ...
                        s = [e],
                        a = [t];
                    if (!i || !o) return e === C ? -1 : t === C ? 1 : i ? -1 : o ? 1 : l ? H(l, e) - H(l, t) : 0;
                ...
                return (e.ownerDocument || e) !== C && A(e), y(e, t)
            }, re.attr = function(e, t) {
                (e.ownerDocument || e) !== C && A(e);
                var n = x.attrHandle[t.toLowerCase()],
                    r = n && D.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !T) : void 0;
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, n = !e[6] && e[2];
                        return X.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && U.test(n) && (t = g(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(e) {
                        ...
                        return 1 === g && 0 === m ? function(e) {
                            ...
                            if (c) {
                                ...
                                if (l = [y ? c.firstChild : c.lastChild], y && d) {
                                    for (p = (a = (r = (i = (o = (s = c)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === S && r[1]) && r[2], s = a && c.childNodes[a]; s = ++a && s && s[u] || (p = a = 0) || l.pop();)
                                        if (1 === s.nodeType && ++p && s === e) {
                                            i[h] = [S, a, p];
                                            break
                                        }
                                } else if (d && (p = a = (r = (i = (o = (s = e)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === S && r[1]), !1 === p)
                                    for (;
                                        (s = ++a && s && s[u] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++p || (d && ((i = (o = s[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [S, p]), s !== e)););
                    ...
                    PSEUDO: function(e, o) {
                        ...
                        return s[E] ? s(o) : 1 < s.length ? (t = [e, e, "", o], x.setFilters.hasOwnProperty(e.toLowerCase()) ? oe(function(e, t) {
                            for (var n, r = s(e, o), i = r.length; i--;) e[n = H(e, r[i])] = !(t[n] = r[i])
                        }) : function(e) {
                            return s(e, 0, t)
                        }) : s
                    }
                ...
                pseudos: {
                    ...
                    lang: oe(function(n) {
                        return V.test(n || "") || re.error("unsupported lang: " + n), n = n.replace(ee, te).toLowerCase(),
                            function(e) {
                                var t;
                                do {
        ...
        function ge(a, e, t) {
            ...
            return e.first ? function(e, t, n) {
                ...
                if (n) {
                    ...
                    for (; e = e[l];)
                        if (1 === e.nodeType || u) {
                            if ((r = (i = (o = e[E] || (e[E] = {}))[e.uniqueID] || (o[e.uniqueID] = {}))[l]) && r[0] === S && r[1] === c) return s[2] = r[2];
        ...
        function ye(p, h, g, m, v, e) {
            return m && !m[E] && (m = ye(m)), v && !v[E] && (v = ye(v, e)), oe(function(e, t, n, r) {
                var i, o, s, a = [],
                    l = [],
                    u = t.length,
                    c = e || function(e, t, n) {
                ...
                if (e) {
                    if (v || p) {
                        ...
                        for (o = d.length; o--;)(s = d[o]) && -1 < (i = v ? H(e, s) : a[o]) && (e[i] = !(t[i] = s))
                    }
                ...
                if (t = x.relative[e[a].type]) c = [ge(me(c), t)];
                    ...
                    if ((t = x.filter[e[a].type].apply(null, e[a].matches))[E]) {
                        ...
                        return ye(1 < a && me(c), 1 < a && he(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(z, "$1"), t, a < n && be(e.slice(a, n)), n < r && be(e = e.slice(n)), n < r && he(e))
                    }
                    c.push(t)
                } return me(c)
        }
        return pe.prototype = x.filters = x.pseudos, x.setFilters = new pe, g = re.tokenize = function(e, t) {
            var n, r, i, o, s, a, l, u = p[e + " "];
            if (u) return t ? 0 : u.slice(0);
            for (s = e, a = [], l = x.preFilter; s;) {
                for (o in n && !(r = B.exec(s)) || (r && (s = s.slice(r[0].length) || s), a.push(i = [])), n = !1, (r = W.exec(s)) && (n = r.shift(), i.push({
                        value: n,
                        type: r[0].replace(z, " ")
                    }), s = s.slice(n.length)), x.filter) !(r = X[o].exec(s)) || l[o] && !(r = l[o](r)) || (n = r.shift(), i.push({
                    value: n,
                    type: o,
                    matches: r
                }), s = s.slice(n.length));
            ...
            if (!s) {
                ...
                (s = k(e, (m = o, y = 0 < (v = i).length, b = 0 < m.length, r = function(e, t, n, r, i) {
                    var o, s, a, l = 0,
                        u = "0",
                        c = e && [],
                        f = [],
                    ...
                    for (i && (w = t === C || t || i); u !== g && null != (o = p[u]); u++) {
                        if (b && o) {
                            for (s = 0, t || o.ownerDocument === C || (A(o), n = !T); a = m[s++];)
                                if (a(o, t || C, n)) {
                                    r.push(o);
                                    break
                                } i && (S = h)
                    ...
                    if (l += u, y && u !== l) {
                        ...
                        if (e) {
                            if (0 < l)
                                for (; u--;) c[u] || f[u] || (f[u] = j.call(r));
                            f = ve(f)
                        }
                        L.apply(r, f), i && !e && 0 < f.length && 1 < l + v.length && re.uniqueSort(r)
                    }
                    return i && (S = h, w = d), c
                }, y ? oe(r) : r))).selector = e
            }
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (i = X.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !x.relative[a = s.type]);)
                    if ((l = x.find[a]) && (r = l(s.matches[0].replace(ee, te), K.test(o[0].type) && de(t.parentNode) || t))) {
                        if (o.splice(i, 1), !(e = r.length && he(o))) return L.apply(n, r), n;
                        break
                    }
            }
            return (u || f(e, c))(r, t, !T, n, !t || K.test(e) && de(t.parentNode) || t), n
        }, h.sortStable = E.split("").sort(N).join("") === E, h.detectDuplicates = !!u, A(), h.sortDetached = se(function(e) {
    ...
    (E.fn.init = function(e, t, n) {
        ...
        if (r[1]) {
            if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), x.test(r[1]) && E.isPlainObject(t))
    ...
    E.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], s = b.test(e) || "string" != typeof e ? E(e, t || this.context) : 0; r < i; r++)
        ...
        E.fn[r] = function(e, t) {
            ...
            return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = E.filter(t, n)), 1 < this.length && (D[r] || E.uniqueSort(n), N.test(r) && n.reverse()), this.pushStack(n)
        }
    });
    var $, L = /\S+/g;
    ...
    E.Callbacks = function(r) {
        ...
        var i, t, o, s, a = [],
            ...
            u = -1,
            c = function() {
                for (s = r.once, o = i = !0; l.length; u = -1)
        ...
        when: function(e) {
            var i, t, n, r = 0,
                ...
                u = function(t, n, r) {
                    return function(e) {
                        n[t] = this, r[t] = 1 < arguments.length ? c.call(arguments) : e, r === i ? l.notifyWith(n, r) : --a || l.resolveWith(n, r)
                    }
                };
            if (1 < s)
                for (i = new Array(s), t = new Array(s), n = new Array(s); r < s; r++) o[r] && E.isFunction(o[r].promise) ? o[r].promise().progress(u(r, t, i)).done(u(r, n, o)).fail(l.reject) : --a;
        ...
        ready: function(e) {
            (!0 === e ? --E.readyWait : E.isReady) || ((E.isReady = !0) !== e && 0 < --E.readyWait || ($.resolveWith(T, [E]), E.fn.triggerHandler && (E(T).triggerHandler("ready"), E(T).off("ready"))))
        }
    }), E.ready.promise = function(e) {
        return $ || ($ = E.Deferred(), "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? C.setTimeout(E.ready) : (T.addEventListener("DOMContentLoaded", q), C.addEventListener("load", q))), $.promise(e)
    }, E.ready.promise();
    var H = function(e, t, n, r, i, o, s) {
            ...
            else if (void 0 !== r && (i = !0, E.isFunction(r) || (s = !0), u && (t = s ? (t.call(e, r), null) : (u = t, function(e, t, n) {
                    return u.call(E(e), n)
                })), t))
        ...
        data: function(r, e) {
            ...
            if (void 0 !== r) return "object" == typeof r ? this.each(function() {
                ...
                if (o && void 0 === t) {
                    ...
                    if (n = E.camelCase(r), void 0 !== (e = R.get(o, n))) return e;
            ...
            if (this.length && (i = R.get(o), 1 === o.nodeType && !P.get(o, "hasDataAttrs"))) {
                for (t = s.length; t--;) s[t] && (0 === (n = s[t].name).indexOf("data-") && (n = E.camelCase(n.slice(5)), z(o, n, i[n])));
    ...
    function V(e, t, n, r) {
        var i, o = 1,
            ...
            c = (E.cssNumber[t] || "px" !== u && +l) && W.exec(E.css(e, t));
        if (c && c[3] !== u)
            for (u = u || c[3], n = n || [], c = +l || 1; c /= o = o || ".5", E.style(e, t, c + u), o !== (o = a() / l) && 1 !== o && --s;);
    ...
    function ne(e, t, n, r, i) {
        for (var o, s, a, l, u, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
            if ((o = e[p]) || 0 === o)
                if ("object" === E.type(o)) E.merge(d, o.nodeType ? [o] : o);
                else if (te.test(o)) {
            for (s = s || f.appendChild(t.createElement("div")), a = (Q.exec(o) || ["", ""])[1].toLowerCase(), l = Y[a] || Y._default, s.innerHTML = l[1] + E.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
            E.merge(d, s.childNodes), (s = f.firstChild).textContent = ""
        } else d.push(t.createTextNode(o));
        for (f.textContent = "", p = 0; o = d[p++];)
            if (r && -1 < E.inArray(o, r)) i && i.push(o);
            else if (u = E.contains(o.ownerDocument, o), s = J(f.appendChild(o), "script"), u && K(s), n)
    ...
    E.event = {
        ...
        add: function(t, e, n, r, i) {
            ...
            if (m)
                for (n.handler && (n = (o = n).handler, i = o.selector), n.guid || (n.guid = E.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                        return void 0 !== E && E.event.triggered !== e.type ? E.event.dispatch.apply(t, arguments) : void 0
                    }), u = (e = (e || "").match(L) || [""]).length; u--;) p = g = (a = oe.exec(e[u]) || [])[1], h = (a[2] || "").split(".").sort(), p && (f = E.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = E.event.special[p] || {}, c = E.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (d = l[p]) || ((d = l[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(t, r, h, s) || t.addEventListener && t.addEventListener(p, s)), f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, c) : d.push(c), E.event.global[p] = !0)
        },
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(L) || [""]).length; u--;)
                    if (p = g = (a = oe.exec(t[u]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                        for (f = E.event.special[p] || {}, d = l[p = (r ? f.delegateType : f.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o], !i && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
                        s && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || E.removeEvent(e, p, m.handle), delete l[p])
                    } else
                        for (p in l) E.event.remove(e, p + t[u], n, r, !0);
                E.isEmptyObject(l) && P.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            e = E.event.fix(e);
            ...
            if ((a[0] = e).delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, e)) {
                for (s = E.event.handlers.call(this, e, l), t = 0;
            ...
            if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                        for (r = [], n = 0; n < a; n++) void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? -1 < E(i, this).index(l) : E.find(i, this, null, [l]).length), r[i] && r.push(o);
                        r.length && s.push({
                            elem: l,
                            handlers: r
                        })
    ...
    function ye(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            R.hasData(e) && (a = R.access(e), l = E.extend({}, a), R.set(t, l))
        }
    }
    ...
    function be(n, r, i, o) {
        ...
        if (f && (t = (e = ne(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = E.map(J(e, "script"), me)).length; c < f; c++) l = e, c !== d && (l = E.clone(l, !0, !0), a && E.merge(s, J(l, "script"))), i.call(n[c], l, c);
            if (a)
                for (u = s[s.length - 1].ownerDocument, E.map(s, ve), c = 0; c < a; c++) l = s[c], G.test(l.type || "") && !P.access(l, "globalEval") && E.contains(u, l) && (l.src ? E._evalUrl && E._evalUrl(l.src) : E.globalEval(l.textContent.replace(he, "")))
        }
        return n
    }
    ...
    E.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e)))
                for (s = J(c), r = 0, i = (o = J(e)).length; r < i; r++) a = o[r], l = s[r], void 0, "input" === (u = l.nodeName.toLowerCase()) && X.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
        ...
        html: function(e) {
            return H(this, function(e) {
                ...
                if ("string" == typeof e && !fe.test(e) && !Y[(Q.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = E.htmlPrefilter(e);
                    try {
    ...
    function Te(e) {
        var t = T,
            n = Ae[e];
        return n || ("none" !== (n = Ce(e, t)) && n || ((t = (we = (we || E("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(), t.close(), n = Ce(e, t), we.detach()), Ae[e] = n), n
    }
    var Ee = /^margin/,
    ...
    function je(e, t, n) {
        ...
        return "" !== (s = (n = n || ke(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== s || E.contains(e.ownerDocument, e) || (s = E.style(e, t)), n && !m.pixelMarginRight() && Se.test(s) && Ee.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    ...
    function $e(e, t) {
        ...
        if (s.style) {
            ...
            s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === s.style.backgroundClip, o.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", o.appendChild(s), E.extend(m, {
    ...
    var Le = /^(none|table(?!-c[ea]).+)/,
        ...
        Oe = ["Webkit", "O", "Moz", "ms"],
        Me = T.createElement("div").style;

    function Pe(e) {
        if (e in Me) return e;
        for (var t = e[0].toUpperCase() + e.slice(1), n = Oe.length; n--;)
            if ((e = Oe[n] + t) in Me) return e
    }
    ...
    function Ie(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; o < 4; o += 2) "margin" === n && (s += E.css(e, n + _[o], !0, i)), r ? ("content" === n && (s -= E.css(e, "padding" + _[o], !0, i)), "margin" !== n && (s -= E.css(e, "border" + _[o] + "Width", !0, i))) : (s += E.css(e, "padding" + _[o], !0, i), "padding" !== n && (s += E.css(e, "border" + _[o] + "Width", !0, i)));
        return s
    }
    ...
    function Fe(e, t, n) {
        ...
        if (i <= 0 || null == i) {
            if (((i = je(e, t, o)) < 0 || null == i) && (i = e.style[t]), Se.test(i)) return i;
    ...
    function ze(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; s < a; s++)(r = e[s]).style && (o[s] = P.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && U(r) && (o[s] = P.access(r, "olddisplay", Te(r.nodeName)))) : (i = U(r), "none" === n && i || P.set(r, "olddisplay", i ? n : E.css(r, "display"))));
    ...
    E.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = E.camelCase(t),
                    l = e.style;
                return t = E.cssProps[a] || (E.cssProps[a] = Pe(a) || a), s = E.cssHooks[t] || E.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : l[t] : ("string" === (o = typeof n) && (i = W.exec(n)) && i[1] && (n = V(e, t, i), o = "number"), void(null != n && n == n && ("number" === o && (n += i && i[3] || (E.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (l[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, s, a = E.camelCase(t);
            return t = E.cssProps[a] || (E.cssProps[a] = Pe(a) || a), (s = E.cssHooks[t] || E.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = je(e, t, r)), "normal" === i && t in He && (i = He[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), E.each(["height", "width"], function(e, s) {
        E.cssHooks[s] = {
            get: function(e, t, n) {
                return t ? Le.test(E.css(e, "display")) && 0 === e.offsetWidth ? Ne(e, qe, function() {
                    return Fe(e, s, n)
                }) : Fe(e, s, n) : void 0
            },
            set: function(e, t, n) {
                ...
                return o && (r = W.exec(t)) && "px" !== (r[3] || "px") && (e.style[s] = t, t = E.css(e, s)), Re(0, t, o)
            }
        }
    }), E.cssHooks.marginLeft = $e(m.reliableMarginLeft, function(e, t) {
        return t ? (parseFloat(je(e, "marginLeft")) || e.getBoundingClientRect().left - Ne(e, {
            marginLeft: 0
        }, function() {
            return e.getBoundingClientRect().left
        })) + "px" : void 0
    }), E.cssHooks.marginRight = $e(m.reliableMarginRight, function(e, t) {
        return t ? Ne(e, {
        ...
        }, Ee.test(i) || (E.cssHooks[i + o].set = Re)
    }), E.fn.extend({
        css: function(e, t) {
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                U(this) ? E(this).show() : E(this).hide()
            })
        }
    ...
    var We, _e, Ue, Ve, Xe, Qe = /^(?:toggle|show|hide)$/,
        Ge = /queueHooks$/;
    ...
    function Ze(o, e, t) {
        var n, s, r = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var e = We || Ye(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), r = 0, i = u.tweens.length; r < i; r++) u.tweens[r].run(n);
        ...
        for (function(e, t) {
            ...
            if (n = Ze.prefilters[r].call(u, o, c, u.opts)) return E.isFunction(n.stop) && (E._queueHooks(u.elem, u.opts.queue).stop = E.proxy(n.stop, n)), n;
        return E.map(c, Ke, u), E.isFunction(u.opts.start) && u.opts.start.call(o, u), E.fx.timer(E.extend(l, {
            elem: o,
            anim: u,
            queue: u.opts.queue
    ...
    E.Animation = E.extend(Ze, {
        ...
        prefilters: [function(t, e, n) {
            var r, i, o, s, a, l, u, c = this,
                ...
                p = t.nodeType && U(t),
                h = P.get(t, "fxshow");
            for (r in n.queue || (null == (a = E._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function() {
                    a.unqueued || l()
                }), a.unqueued++, c.always(function() {
                    c.always(function() {
                        a.unqueued--, E.queue(t, "fx").length || a.empty.fire()
                    })
                })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], "inline" === ("none" === (u = E.css(t, "display")) ? P.get(t, "olddisplay") || Te(t.nodeName) : u) && "none" === E.css(t, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", c.always(function() {
            ...
            if (E.isEmptyObject(f)) "inline" === ("none" === u ? Te(t.nodeName) : u) && (d.display = u);
            else
                for (r in h ? "hidden" in h && (p = h.hidden) : h = P.access(t, "fxshow", {}), o && (h.hidden = !p), p ? E(t).show() : c.done(function() {
                        E(t).hide()
                    }), c.done(function() {
                        var e;
                        for (e in P.remove(t, "fxshow"), f) E.style(t, e, f[e])
                    }), f) s = Ke(p ? h[r] : 0, r, c), r in h || (h[r] = s.start, p && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }],
    ...
    }, Ue = T.createElement("input"), Ve = T.createElement("select"), Xe = Ve.appendChild(T.createElement("option")), Ue.type = "checkbox", m.checkOn = "" !== Ue.value, m.optSelected = Xe.selected, Ve.disabled = !0, m.optDisabled = !Xe.disabled, (Ue = T.createElement("input")).value = "t", Ue.type = "radio", m.radioValue = "t" === Ue.value;
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, s = o ? null : [], a = o ? i + 1 : r.length, l = i < 0 ? a : o ? i : 0; l < a; l++)
                        if (((n = r[l]).selected || l === i) && (m.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !E.nodeName(n.parentNode, "optgroup"))) {
    ...
    E.extend(E.event, {
        trigger: function(e, t, n, r) {
            var i, o, s, a, l, u, c, f = [n || T],
                d = h.call(e, "type") ? e.type : e,
                p = h.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = s = n = n || T, 3 !== n.nodeType && 8 !== n.nodeType && !lt.test(d + E.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), l = d.indexOf(":") < 0 && "on" + d, (e = e[E.expando] ? e : new E.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), c = E.event.special[d] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !E.isWindow(n)) {
                    for (a = c.delegateType || d, lt.test(a + d) || (o = o.parentNode); o; o = o.parentNode) f.push(o), s = o;
                    s === (n.ownerDocument || T) && f.push(s.defaultView || s.parentWindow || C)
                }
                for (i = 0;
                    (o = f[i++]) && !e.isPropagationStopped();) e.type = 1 < i ? a : c.bindType || d, (u = (P.get(o, "events") || {})[e.type] && P.get(o, "handle")) && u.apply(o, t), (u = l && o[l]) && u.apply && O(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = d, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), t) || !O(n) || l && E.isFunction(n[d]) && !E.isWindow(n) && ((s = n[l]) && (n[l] = null), n[E.event.triggered = d](), E.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    }), m.focusin = "onfocusin" in C, m.focusin || E.each({
        focus: "focusin",
        blur: "focusout"
    }, function(n, r) {
        var i = function(e) {
    ...
    xt.href = ut.href, E.extend({
        ...
        ajax: function(e, t) {
            ...
            var c, f, d, n, p, r, h, i, g = E.ajaxSetup({}, t),
                m = g.context || g,
                ...
                A = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === w) {
                            if (!n)
                                for (n = {}; t = ht.exec(d);) n[t[1].toLowerCase()] = t[2];
                            t = n[e.toLowerCase()]
                        }
            ...
            if (y.promise(A).complete = b.add, A.success = A.done, A.error = A.fail, g.url = ((e || g.url || ut.href) + "").replace(dt, "").replace(mt, ut.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = E.trim(g.dataType || "*").toLowerCase().match(L) || [""], null == g.crossDomain) {
                r = T.createElement("a");
                try {
    ...
    E.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !E(this).is(":disabled") && Nt.test(this.nodeName) && !kt.test(e) && (this.checked || !X.test(e))
            }).map(function(e, t) {
                var n = E(this).val();
    ...
    m.cors = !!$t && "withCredentials" in $t, m.ajax = $t = !!$t, E.ajaxTransport(function(i) {
        var o, s;
        return m.cors || $t && !i.crossDomain ? {
            send: function(e, t) {
                var n, r = i.xhr();
                ...
                o = function(e) {
                    return function() {
                        o && (o = s = r.onload = r.onerror = r.onabort = r.onreadystatechange = null, "abort" === e ? r.abort() : "error" === e ? "number" != typeof r.status ? t(0, "error") : t(r.status, r.statusText) : t(jt[r.status] || r.status, r.statusText, "text" !== (r.responseType || "text") || "string" != typeof r.responseText ? {
                            binary: r.response
                        } : {
                            text: r.responseText
    ...
    E.fn.load = function(e, t, n) {
        ...
        setOffset: function(e, t, n) {
            var r, i, o, s, a, l, u = E.css(e, "position"),
                c = E(e),
                f = {};
            "static" === u && (e.style.position = "relative"), a = c.offset(), o = E.css(e, "top"), l = E.css(e, "left"), i = ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (s = (r = c.position()).top, r.left) : (s = parseFloat(o) || 0, parseFloat(l) || 0), E.isFunction(t) && (t = t.call(e, n, E.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, E.fn.extend({
        offset: function(t) {
            ...
            var e, n, r = this[0],
                ...
                o = r && r.ownerDocument;
            return o ? (e = o.documentElement, E.contains(e, r) ? (i = r.getBoundingClientRect(), n = Ot(o), {
        ...
        E.cssHooks[n] = $e(m.pixelPosition, function(e, t) {
            return t ? (t = je(e, n), Se.test(t) ? E(e).position()[n] + "px" : t) : void 0
        })
    }), E.each({
        Height: "height",
        Width: "width"
    ...
    return E.noConflict = function(e) {
        return C.$ === E && (C.$ = Pt), e && C.jQuery === E && (C.jQuery = Mt), E
    }, e || (C.jQuery = C.$ = E), E
}),
function(e) {
    var t, i, n, r, o, s, a, l = navigator.userAgent;
...
function(e, o, u) {
    ...
    var z, B, W, _, U, V, X, Q, G, Y, J, K, Z, ee, te, ne, re, ie, oe, se = (z = /^([\d\.]+)(em|vw|px)$/, B = I(function(e) {
            ...
            var n;
            if (!(e in A))
                if (A[e] = !1, t && (n = e.match(z))) A[e] = n[1] * D[n[2]];
                else try {
                    A[e] = new Function("e", B(e))(D)
                } catch (e) {}
            return A[e]
        }),
        ae = function(e, t) {
        ...
        le = function(e) {
            if (s) {
                ...
                if (i.elements && 1 === i.elements.nodeType && ("IMG" === i.elements.nodeName.toUpperCase() ? i.elements = [i.elements] : (i.context = i.elements, i.elements = null)), r = (t = i.elements || C.qsa(i.context || o, i.reevaluate || i.reselect ? C.sel : C.selShort)).length) {
                    for (C.setupRun(i), $ = !0, n = 0; n < r; n++) C.fillImg(t[n], i);
                    C.teardownRun(i)
                }
            }
        };
    ...
    function ce(e, t) {
        var n, r, i;
        if (e && t)
            for (i = C.parseSet(t), e = C.makeUrl(e), n = 0; n < i.length; n++)
                if (e === C.makeUrl(i[n].url)) {
                    r = i[n];
                    break
                } return r
    }
    e.console && console.warn, S in n || (S = "src"), r["image/jpeg"] = !0, r["image/gif"] = !0, r["image/png"] = !0, r["image/svg+xml"] = o.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), C.ns = ("pf" + (new Date).getTime()).substr(0, 9), C.supSrcset = "srcset" in n, C.supSizes = "sizes" in n, C.supPicture = !!e.HTMLPictureElement, C.supSrcset && C.supPicture && !C.supSizes && (W = o.createElement("img"), n.srcset = "data:,a", W.src = "data:,a", C.supSrcset = n.complete === W.complete, C.supPicture = C.supSrcset && C.supPicture), C.supSrcset && !C.supSizes ? (_ = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", U = o.createElement("img"), V = function() {
        2 === U.width && (C.supSizes = !0), c = C.supSrcset && !C.supSizes, s = !0, setTimeout(le)
    }, U.onload = V, U.onerror = V, U.setAttribute("sizes", "9px"), U.srcset = _ + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w", U.src = _) : s = !0, C.selShort = "picture>img,img[srcset]", C.sel = C.selShort, C.cfg = T, C.DPR = N || 1, C.u = D, C.types = r, C.setSize = t, C.makeUrl = I(function(e) {
        ...
        return e.cands || (e.cands = function(r, f) {
            ...
            function a() {
                var e, t, n, r, i, o, s, a, l, u = !1,
                    c = {};
                for (r = 0; r < p.length; r++) o = (i = p[r])[i.length - 1], s = i.substring(0, i.length - 1), a = parseInt(s, 10), l = parseFloat(s), M.test(s) && "w" === o ? ((e || t) && (u = !0), 0 === a ? u = !0 : e = a) : P.test(s) && "x" === o ? ((e || t || n) && (u = !0), l < 0 ? u = !0 : t = l) : M.test(s) && "h" === o ? ((n || t) && (u = !0), 0 === a ? u = !0 : n = a) : u = !0;
                u || (c.url = d, e && (c.w = e), t && (c.d = t), n && (c.h = n), n || t || e || (c.d = 1), 1 === c.d && (f.has1x = !0), c.set = f, h.push(c))
            }

            function l() {
                for (e(L), t = "", n = "in descriptor";;) {
                    if (i = r.charAt(s), "in descriptor" === n)
                        if (F(i)) t && (p.push(t), t = "", n = "after descriptor");
                        else {
                            if ("," === i) return s += 1, t && p.push(t), void a();
            ...
            for (;;) {
                if (e(q), o <= s) return h;
                d = e(H), p = [], "," === d.slice(-1) ? (d = d.replace(O, ""), a()) : l()
            }
        }(e.srcset, e)), e.cands
        ...
        if (!i && (e = o.body)) {
            var t = o.createElement("div"),
                n = a.style.cssText,
                r = e.style.cssText;
            t.style.cssText = "position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)", a.style.cssText = x, e.style.cssText = x, e.appendChild(t), i = t.offsetWidth, e.removeChild(t), i = parseFloat(i, 10), a.style.cssText = n, e.style.cssText = r
        }
        return i || 16
    }, C.calcListLength = function(e) {
        if (!(e in k) || T.uT) {
            var t = C.calcLength(function(e) {
                var t, n, r, i, o, s, a, l = /^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,
                    u = /^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;
                for (r = (n = function(e) {
                        var t, n = "",
                            r = [],
                    ...
                    if (o = (i = n[t])[i.length - 1], a = o, l.test(a) && 0 <= parseFloat(a) || u.test(a) || "0" === a || "-0" === a || "+0" === a) {
        ...
        var t;
        if (e)
            for (var n = 0, r = (t = C.parseSet(e)).length; n < r; n++) ae(t[n], e.sizes);
        return t
    }, C.setRes.res = ae, C.applySetCandidate = function(e, t) {
        if (e.length) {
            var n, r, i, o, s, a, l, u, c, f, d, p, h, g, m, v, y, b, x, w = t[C.ns],
                A = C.DPR;
            if (a = w.curSrc || t[S], (l = w.curCan || (f = t, d = a, !(p = e[0].set) && d && (p = (p = f[C.ns].sets) && p[p.length - 1]), (h = ce(d, p)) && (d = C.makeUrl(d), f[C.ns].curSrc = d, (f[C.ns].curCan = h).res || ae(h, h.set.sizes)), h)) && l.set === e[0].set && ((c = E && !t.complete && l.res - .1 > A) || (l.cached = !0, l.res >= A && (s = l))), !s)
                for (e.sort(ue), s = e[(o = e.length) - 1], r = 0; r < o; r++)
                    if ((n = e[r]).res >= A) {
                        ...
                        break
                    } s && (u = C.makeUrl(s.url), w.curSrc = u, w.curCan = s, u !== a && C.setSrc(t, s), C.setSize(t))
        }
        ...
        for (t = 0; t < o.length && !i; t++)
            if ((n = o[t]).srcset && C.matchesMedia(n.media) && (r = C.supportsType(n.type))) {
                "pending" === r && (n = r), i = n;
                break
            } return i
        ...
        var r, i, o, s, a = t && "PICTURE" === t.nodeName.toUpperCase(),
            l = e[C.ns];
        (l.src === u || n.src) && (l.src = f.call(e, "src"), l.src ? d.call(e, h, l.src) : p.call(e, h)), (l.srcset === u || n.srcset || !C.supSrcset || e.srcset) && (r = f.call(e, "srcset"), l.srcset = r, s = !0), l.sets = [], a && (l.pic = !0, function(e, t) {
            var n, r, i, o, s = e.getElementsByTagName("source");
            for (n = 0, r = s.length; n < r; n++)(i = s[n])[C.ns] = !0, (o = i.getAttribute("srcset")) && t.push({
                srcset: o,
        ...
        }, l.sets.push(i), (o = (c || l.src) && v.test(l.srcset || "")) || !l.src || ce(l.src, i) || i.has1x || (i.srcset += ", " + l.src, i.cands.push({
            url: l.src,
            d: 1,
            set: i
        }))) : l.src && l.sets.push({
            srcset: l.src,
            sizes: null
        }), l.curCan = null, l.curSrc = u, l.supported = !(a || i && !C.supSrcset || o && !C.supSizes), s && C.supSrcset && !l.supported && (r ? (d.call(e, g, r), e.srcset = "") : p.call(e, g)), l.supported && !l.srcset && (!l.src && e.src || e.src !== C.makeUrl(l.src)) && (null === l.src ? e.removeAttribute("src") : e.src = l.src), l.parsed = !0
    }, C.fillImg = function(e, t) {
        var n, r, i, o, s, a = t.reselect || t.reevaluate;
        (e[C.ns] || (e[C.ns] = {}), n = e[C.ns], a || n.evaled !== l) && (n.parsed && !t.reevaluate || C.parseSets(e, e.parentNode, t), n.supported ? n.evaled = l : (r = e, o = C.getSet(r), s = !1, "pending" !== o && (s = l, o && (i = C.setRes(o), C.applySetCandidate(i, r))), r[C.ns].evaled = s))
    }, C.setupRun = function() {
        $ && !w && N === e.devicePixelRatio || (w = !1, N = e.devicePixelRatio, A = {}, k = {}, C.DPR = N || 1, D.width = Math.max(e.innerWidth || 0, a.clientWidth), D.height = Math.max(e.innerHeight || 0, a.clientHeight), D.vw = D.width / 100, D.vh = D.height / 100, l = [D.height, D.width, N].join("-"), D.em = C.getEmValue(), D.rem = D.em)
    }, C.supPicture ? (le = t, C.fillImg = t) : (Z = e.attachEvent ? /d$|^c/ : /d$|^c|^i/, ee = function() {
        var e = o.readyState || "";
        te = setTimeout(ee, "loading" === e ? 200 : 999), o.body && (C.fillImgs(), (X = X || Z.test(e)) && clearTimeout(te))
    }, te = setTimeout(ee, o.body ? 9 : 99), ne = a.clientHeight, R(e, "resize", (Q = function() {
        w = Math.max(e.innerWidth || 0, a.clientWidth) !== D.width || a.clientHeight !== ne, ne = a.clientHeight, w && C.fillImgs()
    }, G = 99, K = function() {
        var e = new Date - J;
        e < G ? Y = setTimeout(K, G - e) : (Y = null, Q())
    }, function() {
        J = new Date, Y || (Y = setTimeout(K, G))
    })), R(o, "readystatechange", ee)), C.picturefill = le, C.fillImgs = le, C.teardownRun = t, le._ = C, e.picturefillCFG = {
        pf: C,
        push: function(e) {
            var t = e.shift();
            "function" == typeof C[t] ? C[t].apply(C, e) : (T[t] = e[0], $ && C.fillImgs({
                reselect: !0
            }))
        }
    };
...
function(a, r, i, l) {
    ...
    a.fn.lazyload = function(e) {
        ...
        function n() {
            ...
            o.each(function() {
                var e = a(this);
                if (!s.skip_invisible || e.is(":visible"))
                    if (a.abovethetop(this, s) || a.leftofbegin(this, s));
                    else if (a.belowthefold(this, s) || a.rightoffold(this, s)) {
                    if (++t > s.failure_limit) return !1
                } else e.trigger("appear"), t = 0
            })
        }
        return e && (l !== e.failurelimit && (e.failure_limit = e.failurelimit, delete e.failurelimit), l !== e.effectspeed && (e.effect_speed = e.effectspeed, delete e.effectspeed), a.extend(s, e)), t = s.container === l || s.container === r ? u : a(s.container), 0 === s.event.indexOf("scroll") && t.on(s.event, function() {
            return n()
        }), this.each(function() {
            var r = this,
                i = a(r);
            r.loaded = !1, i.attr("src") !== l && !1 !== i.attr("src") || i.is("img") && i.attr("src", s.placeholder), i.one("appear", function() {
                if (!this.loaded) {
                    if (s.appear) {
                        var e = o.length;
                        s.appear.call(r, e, s)
                    ...
                    a("<img />").one("load", function() {
                        ...
                        i.hide(), i.is("img") ? i.attr("src", e) : i.css("background-image", "url('" + e + "')"), i[s.effect](s.effect_speed), r.loaded = !0;
                        var t = a.grep(o, function(e) {
                            return !e.loaded
                        });
                        if (o = a(t), s.load) {
                            var n = o.length;
            ...
            }), 0 !== s.event.indexOf("scroll") && i.on(s.event, function() {
                r.loaded || i.trigger("appear")
            })
        }), u.on("resize", function() {
            n()
        }), /(?:iphone|ipod|ipad).*os 5/gi.test(navigator.appVersion) && u.on("pageshow", function(e) {
        ...
        return (t.container === l || t.container === r ? (r.innerHeight ? r.innerHeight : u.height()) + u.scrollTop() : a(t.container).offset().top + a(t.container).height()) <= a(e).offset().top - t.threshold
    }, a.rightoffold = function(e, t) {
        return (t.container === l || t.container === r ? u.width() + u.scrollLeft() : a(t.container).offset().left + a(t.container).width()) <= a(e).offset().left - t.threshold
    }, a.abovethetop = function(e, t) {
        return (t.container === l || t.container === r ? u.scrollTop() : a(t.container).offset().top) >= a(e).offset().top + t.threshold + a(e).height()
    }, a.leftofbegin = function(e, t) {
        return (t.container === l || t.container === r ? u.scrollLeft() : a(t.container).offset().left) >= a(e).offset().left + t.threshold + a(e).width()
...
function() {
    ...
    t = function() {
        ...
        return e.prototype.defaults = {
            ...
            if (this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live) return new r((s = this, function(e) {
                var t, n, i, o, r;
            ...
            if (null == e && (e = this.element), 1 === e.nodeType) {
                for (o = [], n = 0, r = (i = (e = e.parentNode || e).querySelectorAll("." + this.config.boxClass)).length; n < r; n++) t = i[n], s.call(this.all, t) < 0 ? (this.boxes.push(t), this.all.push(t), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(t, !0), o.push(this.scrolled = !0)) : o.push(void 0);
                return o
            }
            ...
            var n, r, i, o, s, a;
            for (o = (s = l(e)).getPropertyCSSValue(t), n = 0, r = (i = this.vendors).length; n < r; n++) a = i[n], o = o || s.getPropertyCSSValue("-" + a + "-" + t);
            return o
...
browser.match(/MSIE 10.0/i) ? $("body").addClass("ie10") : browser.match(/rv:11.0/i) && $("body").addClass("ie11"), (new WOW).init(), $(window).load(function() {
    $(".load").fadeOut(500), $(".header").addClass("loaded")
}), $(function() {
    var n, t, e, r, i, o, s = navigator.userAgent,
        a = $(window).width(),
        l = 0,
        u = $("html, body"),
        c = $(".header"),
    ...
    function d() {
        $(".resize-item").removeAttr("style"), console.log("clear!!"), setTimeout(p, 300)
    }

    function p() {
        for (var e, t = 0, n = 0; n < $(".resize-item").size(); n++) t <= (e = $(".resize-item").eq(n).height()) && (t = e), console.log(e);
        $(".resize-item").height(t), console.log(t)
    }
    $(".video").fitVids(), s.match(/iPhone|iPad|iPod|Android|BlackBerry/i) ? u.addClass("mobile") : s.match(/rv:11/i) ? u.addClass("ie") : u.addClass("desktop"), $(".nav-toggle").on("click", m), $(".mask").on("click", m), 0 !== $(".category-nav").size() && "#" === $(".category-nav a").eq(0).attr("href") && $(".category-nav").on("click", "a", function() {
        t = $(this).index(".category-nav a");
        var e = $(".list-wtb").eq(t).offset();
        return u.stop(!0, !1).animate({
            scrollTop: e.top - 70
        }, 500), !1
    }), 0 !== $(".video").size() && $(".video").fitVids(), 0 !== $(".fixbar").size() && (0 === $(".fixbar-after").size() ? alert("ä½ æ²’æœ‰åŠ  fixbar-after å•¦") : (i = $(".fixbar-after"), r = $(".fixbar"), $(window).scroll(function() {
        e = i.offset(), $(window).scrollTop() > e.top ? r.addClass("fixed") : r.removeClass("fixed")
    }))), A(), v(), $(window).scroll(function() {
        150 < $(window).scrollTop() ? (c.addClass("fixed"), f.addClass("fixed")) : (c.removeClass("fixed"), f.removeClass("fixed"))
    }), $(window).resize(function() {
        $(".nav-toggle").removeClass("show"), $(".page").removeClass("show"), $("html,body").removeClass("show"), $(".nav").removeClass("show"), $(".hassub > .submenu").removeAttr("style"), $(".hassub").removeClass("open"), v(), d(), w(function() {
            A()
        }, 200)
    }), $(".hassub").hover(function() {
        $(".searchbar").removeClass("open")
    }), $(".nav-close").on("click", m), $(".lazy").lazyload({
        threshold: 500,
        effect: "fadeIn"
    }), d();
    var h, g = 0;
    ...
    function m() {
        return $(".page").toggleClass("show"), $("html,body").toggleClass("show"), $(".nav-toggle").toggleClass("show"), $(".nav").toggleClass("show"), !1
    }

    function v() {
        o = $("#js-rwd").width(), l = 0 === o ? 0 : 1
    }
    if ($(".tags").on("click", "a", function() {
            if (2 != (h = $(this).index(".tags a"))) return $(this).addClass("current"), $(".tags a").eq(g).removeClass("current"), $(".tags-contents").eq(g).removeClass("show"), $(".tags-contents").eq(h).addClass("show"), g = h, !1
        }), $(".hassub").on("click", function() {
            0 === l && ($(this).toggleClass("open").find(".submenu").slideToggle(), $(this).siblings(".hassub").removeClass("open").find(".submenu").slideUp())
        }), $(".hasthird").on("click", "li", function() {
            if (0 === l && $(this).hasClass("title")) {
                var e = $(this).parent("ul"),
                    t = $(this).height() + 1,
                    n = e.innerHeight(),
                    r = e.css("height", "auto").innerHeight();
                return e.siblings("ul").animate({
                    height: t
                }, function() {
                    $(this).removeAttr("style"), $(this).removeClass("current")
                }), e.hasClass("current") ? e.removeClass("current") : e.addClass("current"), e.css("height", n).animate({
                    height: n == r ? t : r
                }), !1
            }
        }), 0 !== $(".edit").size() && ($(".edit img").removeAttr("style"), $("img.big").unwrap("p")), 0 !== $(".section-nav").size() && (! function() {
            var e = $(".spec").size(),
                t = $(".download").size();
            1 === e && 1 === t && $(".section-nav a").eq(2).remove();
            0 === t && 0 === e ? $(".section-nav a:eq(2), .section-nav a:eq(3)").remove() : 0 === t && 0 !== e && $(".section-nav a").eq(3).remove();
            n = $(".section-nav"), r = 0 - n.outerHeight(!1) / 2, n.css("margin-top", r);
            var n, r
        }(), $(".section-nav").on("click", "a", function() {
            n = $(this).index(".section-nav a");
            var e = $(".section-nav a").size() - 1;
            if (n !== e) {
                var t = $(".bookmark").eq(n).offset();
                u.stop(!0, !1).animate({
                    scrollTop: t.top
                }, 500)
            } else u.stop(!0, !1).animate({
                scrollTop: 0
            }, 500);
            return !1
        })), 0 !== $(".pos-middle").size()) {
        var y = $(".pos-middle"),
            b = 0 - y.outerHeight(!1) / 2;
        y.css("margin-top", b)
    }
    var x, w = (x = 0, function(e, t) {
        clearTimeout(x), x = setTimeout(e, t)
    });

    function A() {
        a = $(window).width(), 0 !== $(".bg").size() && 842 < a ? $(".bg").each(function(e, t) {
            var n = 'url("' + $(this).find("img").attr("data-src") + '")';
            $(this).css({
                "background-image": n
            })
